    ...
    <div class="container-fluid bg-page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-3 text-white text-uppercase">istesheer</h3>
...
<div id="services">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row"><h1 class="col-12 text-b text-uppercase text-center">Our Services</h1></div>
            <div class="row pt-2">
                
                <div class="col-lg-3">
                    
                    <h3 class="mb-4">Our Practice Areas</h3>
