...
return [
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                'create.hearing', 'update.hearing', 'create.action', 'update.action', 'delete.files',
                'social.login', 'callback.myfatoorah', 'callback.response.myfatoorah', 'create.voucher', 'delete.voucher', 'update.voucher', 'test.fcm'
            ],
